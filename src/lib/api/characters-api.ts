 ...
 */
export async function getCharacters(projectId: string, token: string): Promise<Character[]> {
 ...
 */
export async function getCharacter(characterId: string, token: string): Promise<Character> {
 ...
 * Delete a character
 */
export async function deleteCharacter(characterId: string, token: string): Promise<void> {
