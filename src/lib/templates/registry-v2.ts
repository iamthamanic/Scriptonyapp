...
import type { TemplateDefinition, TemplateRegistry as ITemplateRegistry, ProjectType, LevelConfig } from './types';
...
export const FILM_3ACT: TemplateDefinition = {
  ...
  type: 'film',
  name: '3-Akt-Struktur',
  description: 'Klassische Hollywood-Struktur (Setup, Confrontation, Resolution)',
  
  levels: {
    level_1: { name: 'Act', namePlural: 'Acts', icon: '🎬', color: '#6E59A5' },
    level_2: { name: 'Sequence', namePlural: 'Sequences', icon: '📽️', color: '#8B7BB8' },
    level_3: { name: 'Scene', namePlural: 'Scenes', icon: '🎥', color: '#A89CC8' },
    level_4: { name: 'Shot', namePlural: 'Shots', icon: '📸', color: '#C5BDD8' },
  },
  ...
  metadataSchema: {
    level_3: {
      timeOfDay: { 
        type: 'enum', 
        label: 'Time of Day',
        values: ['day', 'night', 'dawn', 'dusk', 'morning', 'afternoon', 'evening'] 
      },
    ...
    level_4: {
      cameraAngle: { 
        type: 'enum',
        label: 'Camera Angle',
        values: ['eye-level', 'high-angle', 'low-angle', 'birds-eye', 'dutch-angle', 'over-shoulder'] 
      },
      cameraMovement: { 
        type: 'enum',
        label: 'Camera Movement',
        values: ['static', 'pan', 'tilt', 'dolly', 'tracking', 'handheld', 'crane', 'steadicam'] 
      },
      framing: {
        type: 'enum',
        label: 'Framing',
...
export const FILM_HEROES_JOURNEY: TemplateDefinition = {
  ...
  levels: {
    level_1: { name: 'Stage', namePlural: 'Stages', icon: '🗺️', color: '#6E59A5' },
    level_2: { name: 'Phase', namePlural: 'Phases', icon: '⚡', color: '#8B7BB8' },
    level_3: { name: 'Scene', namePlural: 'Scenes', icon: '🎥', color: '#A89CC8' },
    level_4: { name: 'Shot', namePlural: 'Shots', icon: '📸', color: '#C5BDD8' },
  },
  ...
  predefinedNodes: {
    level_1: [
      { number: 1, title: 'Ordinary World', description: 'Hero\'s normal life before adventure' },
      { number: 2, title: 'Call to Adventure', description: 'Hero faces a challenge or quest' },
      { number: 3, title: 'Refusal of the Call', description: 'Hero hesitates or refuses the call' },
      { number: 4, title: 'Meeting the Mentor', description: 'Hero meets wise guide or mentor' },
      { number: 5, title: 'Crossing the Threshold', description: 'Hero commits to the adventure' },
      { number: 6, title: 'Tests, Allies, Enemies', description: 'Hero learns rules of special world' },
      { number: 7, title: 'Approach to Inmost Cave', description: 'Hero approaches the central ordeal' },
      { number: 8, title: 'Ordeal', description: 'Hero faces greatest fear/challenge' },
      { number: 9, title: 'Reward (Seizing the Sword)', description: 'Hero takes possession of treasure' },
      { number: 10, title: 'The Road Back', description: 'Hero begins journey back to ordinary world' },
      { number: 11, title: 'Resurrection', description: 'Hero faces final test using all learned' },
      { number: 12, title: 'Return with the Elixir', description: 'Hero returns home transformed' },
    ],
  },
...
export const FILM_SAVE_THE_CAT: TemplateDefinition = {
  ...
  levels: {
    level_1: { name: 'Beat', namePlural: 'Beats', icon: '🎵', color: '#6E59A5' },
    level_2: { name: 'Sequence', namePlural: 'Sequences', icon: '📽️', color: '#8B7BB8' },
    level_3: { name: 'Scene', namePlural: 'Scenes', icon: '🎥', color: '#A89CC8' },
    level_4: { name: 'Shot', namePlural: 'Shots', icon: '📸', color: '#C5BDD8' },
  },
  ...
  predefinedNodes: {
    level_1: [
      { number: 1, title: 'Opening Image', description: 'First impression of story' },
      { number: 2, title: 'Theme Stated', description: 'Core theme/lesson mentioned' },
      { number: 3, title: 'Set-Up', description: 'Introduce characters and world' },
      ...
      { number: 10, title: 'Bad Guys Close In', description: 'Things get worse' },
      { number: 11, title: 'All Is Lost', description: 'Lowest point' },
      { number: 12, title: 'Dark Night of the Soul', description: 'Hero reflects' },
      { number: 13, title: 'Break into Three', description: 'Solution found' },
      { number: 14, title: 'Finale', description: 'Climax and resolution' },
      { number: 15, title: 'Final Image', description: 'Opposite of opening image' },
    ],
  },
...
export const SERIES_TRADITIONAL: TemplateDefinition = {
  ...
  levels: {
    level_1: { name: 'Season', namePlural: 'Seasons', icon: '📺', color: '#6E59A5' },
    level_2: { name: 'Episode', namePlural: 'Episodes', icon: '🎞️', color: '#8B7BB8' },
    level_3: { name: 'Scene', namePlural: 'Scenes', icon: '🎥', color: '#A89CC8' },
    level_4: { name: 'Shot', namePlural: 'Shots', icon: '📸', color: '#C5BDD8' },
  },
...
export const BOOK_NOVEL: TemplateDefinition = {
  ...
  levels: {
    level_1: { name: 'Part', namePlural: 'Parts', icon: '📚', color: '#6E59A5' },
    level_2: { name: 'Chapter', namePlural: 'Chapters', icon: '📖', color: '#8B7BB8' },
    level_3: { name: 'Section', namePlural: 'Sections', icon: '📄', color: '#A89CC8' },
  },
  ...
  metadataSchema: {
    level_2: {
      ...
      pov: { 
        type: 'enum', 
        label: 'Point of View',
        values: ['first-person', 'third-person-limited', 'third-person-omniscient', 'second-person'] 
      },
...
export const THEATER_CLASSIC: TemplateDefinition = {
  ...
  levels: {
    level_1: { name: 'Act', namePlural: 'Acts', icon: '🎭', color: '#6E59A5' },
    level_2: { name: 'Scene', namePlural: 'Scenes', icon: '🎬', color: '#8B7BB8' },
    level_3: { name: 'Beat', namePlural: 'Beats', icon: '💬', color: '#A89CC8' },
  },
  ...
  predefinedNodes: {
    level_1: [
      { number: 1, title: 'Exposition', description: 'Einführung in Figuren und Situation' },
  ...
  metadataSchema: {
    level_2: {
      ...
      charactersPresent: { type: 'array', label: 'Characters Present', itemType: 'string' },
...
export const GAME_NARRATIVE: TemplateDefinition = {
  ...
  levels: {
    level_1: { name: 'Chapter', namePlural: 'Chapters', icon: '🎮', color: '#6E59A5' },
    level_2: { name: 'Level', namePlural: 'Levels', icon: '🗺️', color: '#8B7BB8' },
    level_3: { name: 'Mission', namePlural: 'Missions', icon: '⚔️', color: '#A89CC8' },
    level_4: { name: 'Cutscene', namePlural: 'Cutscenes', icon: '🎬', color: '#C5BDD8' },
  },
  ...
  metadataSchema: {
    level_2: {
      ...
      estimatedPlaytime: { type: 'number', label: 'Est. Playtime (minutes)', min: 0 },
      environment: { type: 'string', label: 'Environment' },
    },
    level_3: {
      objective: { type: 'string', label: 'Primary Objective' },
      secondaryObjectives: { type: 'array', label: 'Secondary Objectives', itemType: 'string' },
...
export const TemplateRegistry: ITemplateRegistry = {
  ...
  getLevelConfig(templateId: string, level: 1 | 2 | 3 | 4): LevelConfig | undefined {
    const template = this.get(templateId);
    if (!template) return undefined;
    
    const levelKey = `level_${level}` as 'level_1' | 'level_2' | 'level_3' | 'level_4';
