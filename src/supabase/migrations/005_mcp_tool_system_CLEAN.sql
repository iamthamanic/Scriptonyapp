...
-- Date: 2025-10-15
-- CLEAN VERSION (No DO blocks, no special characters)
...
-- Migration complete!
-- - RAG sync queue table created
-- - Auto-sync triggers installed on 5 tables
-- - Tool call history tracking enabled
