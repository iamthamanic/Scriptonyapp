...
import { Play, Pause, Trash2, ChevronDown, ChevronRight, Edit2 } from 'lucide-react';
...
export function AudioFileList({ files, type, onDelete, onEdit, className = '' }: AudioFileListProps) {
  ...
  const handlePlayPause = (file: AudioFile) => {
    ...
    if (!audio) {
      ...
      console.error('[AudioFileList] Available audio refs:', Object.keys(audioRefs.current));
      console.error('[AudioFileList] This usually means useEffect did not run or files changed');
      return;
    }
  ...
  useEffect(() => {
    ...
    files.forEach((file) => {
        ...
        audio.addEventListener('loadstart', () => console.log('[AudioFileList] Audio load started:', file.fileName));
        ...
        audio.addEventListener('play', () => console.log('[AudioFileList] Audio PLAY event fired:', file.fileName));
        audio.addEventListener('pause', () => console.log('[AudioFileList] Audio PAUSE event fired:', file.fileName));
