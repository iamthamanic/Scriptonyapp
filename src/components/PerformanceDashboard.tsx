...
import { perfMonitor, SLA_TARGETS, type SLACategory } from '../lib/performance-monitor';
  ...
  return (
    <div className="fixed bottom-4 right-4 z-[9999] w-96 bg-white dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-700 rounded-lg shadow-2xl max-h-[80vh] overflow-hidden flex flex-col">
      ...
      <div className={cn(
        ...
        isHealthy ? "bg-green-50 dark:bg-green-900/20" : "bg-red-50 dark:bg-red-900/20"
      )}>
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-xs text-gray-600 dark:text-gray-400">
              {overallStats.total} measurements • {violationRate.toFixed(1)}% violations
            </p>
          </div>
        </div>
        <Button
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
            <div className="bg-gray-50 dark:bg-gray-800 p-2 rounded">
              ...
              <div className="font-semibold">{cacheStats.memoryEntries} entries</div>
            </div>
            <div className="bg-gray-50 dark:bg-gray-800 p-2 rounded">
              <div className="text-gray-600 dark:text-gray-400">LocalStorage</div>
              <div className="font-semibold">{cacheStats.localStorageEntries} entries</div>
            </div>
            <div className="bg-gray-50 dark:bg-gray-800 p-2 rounded col-span-2">
              ...
              <div className="font-semibold">{(cacheStats.totalSize / 1024).toFixed(1)} KB</div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
            <div className="bg-gray-50 dark:bg-gray-800 p-2 rounded">
              ...
              <div className="font-semibold">{prefetchStats.prefetchedKeys}</div>
            </div>
            <div className="bg-gray-50 dark:bg-gray-800 p-2 rounded">
              ...
              .map(([category, s]) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className={cn(
                      "font-semibold",
                      isViolated ? "text-red-600 dark:text-red-400" : "text-green-600 dark:text-green-400"
                    )}>
